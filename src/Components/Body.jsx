...
function Body() {
  return (
    <div className="p-4 md:p-8 mt-5 max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl md:border-none">
      ...
      <img src={bodyImage} alt="Body Image" className="w-full h-auto rounded-lg mb-4 md:mb-6" />
      
      <h2 className="text-2xl md:text-3xl font-bold text-left mb-4 md:mb-6 mt-4 md:mt-5">
        Introduction
      </h2>
      ...
      <h2 className="text-xl md:text-2xl font-bold mt-6 mb-4">The Significance of Data Privacy</h2>
      <h3 className="text-lg md:text-xl font-semibold mb-2">For Individuals</h3>
      <p className="mb-4 text-sm md:text-base">
      ...
      <h3 className="text-lg md:text-xl font-semibold mb-2">From a Business Perspective</h3>
      <p className="mb-4 text-sm md:text-base">
      ...
      <h2 className="text-xl md:text-2xl font-bold mt-6 mb-4">Conclusion</h2>
      <p className="mb-4 text-sm md:text-base">
      ...
      <h2 className="text-xl md:text-2xl font-bold mt-6 mb-4">Lejhro's Role</h2>
      <p className="mb-4 text-sm md:text-base">
